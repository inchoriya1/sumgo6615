...
(function () {
  ...
  var PARTS = {
    ...
    'excel-m1': { label: '엑셀 마스터 1장 — 처음에 해 두면 평생 편한 것들', href: 'excel-m1.html' },
    'excel-m2': { label: '엑셀 마스터 2장 — 남이 만든 엉망인 표를 쓸 수 있게', href: 'excel-m2.html' },
    'excel-m3': { label: '엑셀 마스터 3장 — 같은 표인데 읽히는 표',     href: 'excel-m3.html' },
    'excel-m4': { label: '엑셀 마스터 4장 — 남에게 넘기기 전에',        href: 'excel-m4.html' },
    'excel-m5': { label: '엑셀 마스터 5장 — 수천 줄에서 필요한 것만',   href: 'excel-m5.html' },
    'excel-m6': { label: '엑셀 마스터 6장 — 자료가 늘어도 보고서는 그대로', href: 'excel-m6.html' },
    'excel-m7': { label: '엑셀 마스터 7장 — 열 몇 개면 거의 다 됩니다', href: 'excel-m7.html' },
    'excel-m8': { label: '엑셀 마스터 8장 — 그림이 거짓말하지 않게',    href: 'excel-m8.html' },
    'excel-m9': { label: '엑셀 마스터 부록 — 한 걸음 더',               href: 'excel-m9.html' },
